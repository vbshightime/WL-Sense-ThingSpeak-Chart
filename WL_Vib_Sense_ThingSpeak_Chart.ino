...
//       snprintf(messagePayload,MESSAGE_MAX_LEN, messageData,Xrms,Yrms,tempC);
  //     Serial.println(messagePayload);
       //int randomX = random(8, 200);
       //int randomY = random(2, 200);
       //String dataString; 
       //Serial.println(randomX);
       //Serial.println(randomY);
       //char rmsBuffx[4];
       //char rmsBuffy[4];
       //sprintf(rmsBuffx,"%d",rms_x);
       //sprintf(rmsBuffy,"%d",rms_y);
       //String strx(rmsBuffx,DEC);
       //String stry(rmsBuffy,DEC);
       ...
       //if(randomX > 180 || randomY< 20){
          
         //dataString = String("field1="+ String(randomX) + "&field2=" + String(randomY) + "&field3=" + String(cTemp));  
        //}else{
          //randomX = 90;
          //randomY = 40;
         //dataString = String("field1="+ String(randomX) + "&field2=" + String(randomY) + "&field3=" + String(cTemp));     
